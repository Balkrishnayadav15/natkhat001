...
<%
	...
	String sGender = (String)request.getAttribute("GENDER");
	
%>
	<div id="roundrect1"
		style="position: absolute; overflow: hidden; left: 13px; top: 116px; width: 977px; height: 123px; z-index: 0">
		<img border=0 width="100%" height="100%" alt=""
			src="<%=appUrl %>natkhat/images/roundrect16057276.gif">
	</div>
	...
	<div id="sStudent"
		style="position: absolute; overflow: hidden; left: 386px; top: 119px; width: 241px; height: 30px; z-index: 4">
		<div class="wpmd">
			<div align=center>
	...
	<div id=""
		style="position: absolute; overflow: hidden; left: 46px; top: 162px; width: 178px; height: 25px; z-index: 5">
		<div class="wpmd">
			<div>
	...
	<div id=""
		style="position: absolute; overflow: hidden; left: 343px; top: 162px; width: 190px; height: 25px; z-index: 6">
		<div class="wpmd">
			<div>
				<font color="#000000" face="Copperplate Gothic Bold" class="ws16">Select
					Section</font>
	...
	<div id="table2"
		style="position: absolute; overflow: auto; left: 9px; top: 314px; max-width: 99%;  z-index: 10">
		<div class="wpmd">
			<div>
	...
	<div id=""
		style="position: absolute; overflow: hidden; left: 666px; top: 162px; width: 190px; height: 25px; z-index: 11">
		<div class="wpmd">
			<div>
				<font color="#000000" face="Copperplate Gothic Bold" class="ws16">Select
					Gender</font>
	...
	<div id="ssbgWise"
		style="position: absolute; overflow: hidden; left: 281px; top: 41px; width: 445px; height: 69px; z-index: 13">
		<div class="wpmd">
			<div align=center>
			...
			<div align=center>
				<font color="#000000" face="Copperplate Gothic Bold" class="ws18"><B><U>(Boys
							Grils Wise)</U></B></font>
			</div>
		</div>
	</div>
	...
	<div id="tStudents"
		style="position: absolute; overflow: hidden; left: 778px; top: 45px; width: 217px; height: 58px; z-index: 14">
		<div class="wpmd">
			<div>
...
<form id="bGirslForm" action="clrkSearchBoysGirls" >
	<select name="sClass" id="sClass"
		...
		<select name="sSection" id="sSection"
			style="position: absolute; width: 98px; left: 528px; top: 162px; z-index: 8">
	...
	<select name="sGender"  id="sGender" 
		style="position: absolute; left: 849px; top: 164px; width: 98px; z-index: 12">
		<option value="" <% if(null == sGender){ %> selected <% } %>>Select</option>
		<option value="Male" <% if(null != sGender && "Male".equals(sGender)){ %>
				selected <% } %>>Boys</option>
		<option value="Female" <% if(null != sGender && "Female".equals(sGender)){ %>
				selected <% } %>>Girls</option>
	</select>
	<input name="submitBGirls" id="submitBGirls" type="button" style="position: absolute; left: 384px; top: 263px; z-index: 16;" value="Search Student">
	<input type="button" id="refreshBGirslForm" style="position: absolute; left: 548px; top: 263px; z-index: 16;" value="Refresh"> 
