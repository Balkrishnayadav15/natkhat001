...
<body>
	...
	<div id="image3"
		style="position: absolute; overflow: hidden; left: 264px; top: 92px; width: 64px; height: 64px; z-index: 9">
		<img src="<%=appUrl %>natkhat/images/documents1.png" alt="" title="" border=0
			width=64 height=64>
	</div>
	...
	<div id="documents"
		...
		<div class="wpmd">
			<div>
				<font color="#FF6600" face="Copperplate Gothic Bold" class="ws20">Documents</font>
			</div>
		</div>
	</div>
	...
	<div id="asheet"
		style="position: absolute; overflow: hidden; left: 53px; top: 278px; width: 162px; height: 49px; z-index: 14">
		<a href="clerkDashboard.html"><div class="wpmd">
				<div>
	...
	<div id="documents2"
		...
		<a href="feeReport.html"><div class="wpmd">
				<div>
	...
	<div id="chPage"
		style="position: absolute; overflow: hidden; left: 53px; top: 633px; width: 198px; height: 50px; z-index: 26">
	...
	<div id="image4"
		style="position: absolute; overflow: hidden; left: 1px; top: 633px; width: 45px; height: 45px; z-index: 27">
		<img src="<%=appUrl %>natkhat/images/createHomePage1.png" alt="" title=""
			border=0 width=45 height=45>
	</div>

	<div id="roundrect3"
		style="position: absolute; overflow: hidden; left: 315px; top: 180px; width: 163px; height: 97px; z-index: 28">
		<a href="clerkDocumentsPendingSheet.jsp"><img border=0
			width="100%" height="100%" alt=""
			src="<%=appUrl %>natkhat/images/roundrect1881902.gif"></a>
	</div>

	<div id="dpSheet"
		style="position: absolute; overflow: hidden; left: 293px; top: 279px; width: 205px; height: 59px; z-index: 29">
		<a href="clerkDocumentsPendingSheet.jsp"><div class="wpmd">
				<div align=center>
					<font color="#000000" face="Copperplate Gothic Bold" class="ws14"><B>Dcouments</B></font>
				</div>
				<div align=center>
					<font color="#000000" face="Copperplate Gothic Bold" class="ws14"><B>Pending
							Sheet</B></font>
				</div>
			</div></a>
	</div>
	...
	<div id="image5"
		style="position: absolute; overflow: hidden; left: 358px; top: 188px; width: 84px; height: 84px; z-index: 30">
		<a href="clerkDocumentsPendingSheet.jsp"><img
			src="<%=appUrl %>natkhat/images/documentsPending.png" alt="" title="" border=0
			width=84 height=84></a>
	</div>

	<div id="roundrect4"
		style="position: absolute; overflow: hidden; left: 597px; top: 180px; width: 163px; height: 97px; z-index: 31">
		<a href="clerkStudentListSection.jsp"><img border=0 width="100%"
			height="100%" alt="" src="<%=appUrl %>natkhat/images/roundrect1881902.gif"></a>
	</div>

	<div id="cswsList"
		style="position: absolute; overflow: hidden; left: 555px; top: 277px; width: 248px; height: 54px; z-index: 32">
		<a href="clerkStudentListSection.jsp"><div class="wpmd">
				<div align=center>
					<font color="#000000" face="Copperplate Gothic Bold" class="ws14"><B>Class-Section</B></font>
				</div>
				<div align=center>
					<font color="#000000" face="Copperplate Gothic Bold" class="ws14"><B>Wise
							Students List</B></font>
				</div>
			</div></a>
	</div>

	<div id="image6"
		style="position: absolute; overflow: hidden; left: 635px; top: 183px; width: 92px; height: 92px; z-index: 33">
		<a href="clerkStudentListSection.jsp"><img
			src="<%=appUrl %>natkhat/images/sectionWiseStudents.png" alt="" title=""
			border=0 width=92 height=92></a>
	</div>

	<div id="roundrect5"
		style="position: absolute; overflow: hidden; left: 906px; top: 180px; width: 163px; height: 97px; z-index: 34">
		<a href="clerkStudentListBoysGrils.jsp"><img border=0 width="100%"
			height="100%" alt="" src="<%=appUrl %>natkhat/images/roundrect1881902.gif"></a>
	</div>

	<div id="cswbgslist"
		style="position: absolute; overflow: hidden; left: 844px; top: 277px; width: 305px; height: 51px; z-index: 35">
		<a href="clerkStudentListBoysGrils.jsp"><div class="wpmd">
				<div align=center>
					<font color="#000000" face="Copperplate Gothic Bold" class="ws14"><B>Class-Section
							Wise</B></font>
				</div>
				<div align=center>
					<font color="#000000" face="Copperplate Gothic Bold" class="ws14"><B>Boys
							&amp; Girls Seprate List</B></font>
				</div>
			</div></a>
	</div>

	<div id="image13"
		style="position: absolute; overflow: hidden; left: 939px; top: 194px; width: 98px; height: 82px; z-index: 36">
		<a href="clerkStudentListBoysGrils.jsp"><img
			src="<%=appUrl %>natkhat/images/classWiseBoysGirls1.png" alt="" title=""
			border=0 width=98 height=82></a>
	</div>

	<div id="roundrect7"
		style="position: absolute; overflow: hidden; left: 316px; top: 347px; width: 163px; height: 97px; z-index: 37">
		<a href="clerkStudentListAge.jsp"><img border=0 width="100%"
			height="100%" alt="" src="<%=appUrl %>natkhat/images/roundrect1881902.gif"></a>
	</div>

	<div id="cswacList"
		style="position: absolute; overflow: hidden; left: 284px; top: 446px; width: 238px; height: 47px; z-index: 38">
		<a href="clerkStudentCategory.jsp"><div class="wpmd">
				<div align=center>
					<font color="#000000" face="Copperplate Gothic Bold" class="ws14"><B>Class-Section
							Wise</B></font>
				</div>
				<div align=center>
					<font color="#000000" face="Copperplate Gothic Bold" class="ws14"><B>All
							Categories List </B></font>
				</div>
			</div></a>
	</div>

	<div id="image15"
		style="position: absolute; overflow: hidden; left: 342px; top: 357px; width: 111px; height: 83px; z-index: 39">
		<a href="clerkStudentCategory.jsp"><img
			src="<%=appUrl %>natkhat/images/categoryWiseStudents2.png" alt="" title=""
			border=0 width=111 height=83></a>
	</div>

	<div id="roundrect8"
		style="position: absolute; overflow: hidden; left: 597px; top: 347px; width: 163px; height: 97px; z-index: 40">
		<a href="clerkStudentListAge.jsp"><img border=0 width="100%"
			height="100%" alt="" src="<%=appUrl %>natkhat/images/roundrect1881918.gif"></a>
	</div>

	<div id="cswasheet"
		style="position: absolute; overflow: hidden; left: 557px; top: 444px; width: 256px; height: 54px; z-index: 41">
		<a href="clerkStudentListAge.jsp"><div class="wpmd">
				<div align=center>
					<font color="#000000" face="Copperplate Gothic Bold" class="ws14"><B>Class-Section
							Wise </B></font>
				</div>
				<div align=center>
					<font color="#000000" face="Copperplate Gothic Bold" class="ws14"><B>Age
							Sheet</B></font>
				</div>
			</div></a>
	</div>
	...
	<div id="image16"
		style="position: absolute; overflow: hidden; left: 637px; top: 354px; width: 86px; height: 86px; z-index: 42">
		<a href="clerkStudentListAge.jsp"><img
			src="<%=appUrl %>natkhat/images/Agewise.png" alt="" title="" border=0 width=86
			height=86></a>
	</div>
