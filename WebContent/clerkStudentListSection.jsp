...
%>
	...
	<div id="table2"
		style="position: absolute; overflow: auto; left: 9px; top: 370px; max-width: 98%; z-index: 3">
		<div class="wpmd">
			<div>
	...
	<div id="sssWise"
		style="position: absolute; overflow: hidden; left: 285px; top: 41px; width: 445px; height: 69px; z-index: 4">
		<div class="wpmd">
			<div align=center>
			...
			<div align=center>
				<font color="#000000" face="Copperplate Gothic Bold" class="ws18"><B><U>(Section
							Wise)</U></B></font>
			</div>
		</div>
	</div>
	...
	<div id="roundrect1"
		style="position: absolute; overflow: hidden; left: 68px; top: 210px; width: 879px; height: 102px; z-index: 6">
		<img border=0 width="100%" height="100%" alt=""
			src="<%=appUrl %>natkhat/images/roundrect16005983.gif">
	</div>

	<div id="sStudent"
		style="position: absolute; overflow: hidden; left: 390px; top: 117px; width: 241px; height: 30px; z-index: 7">
		<div class="wpmd">
			<div align=center>
	...
	<div id=""
		style="position: absolute; overflow: hidden; left: 149px; top: 250px; width: 132px; height: 25px; z-index: 8">
		<div class="wpmd">
			<div>
	...
	<div id=""
		style="position: absolute; overflow: hidden; left: 484px; top: 250px; width: 190px; height: 25px; z-index: 9">
		<div class="wpmd">
			<div>
				<font color="#000000" face="Copperplate Gothic Bold" class="ws16">By
					Scholar no.</font>
	...
	<div id="roundrect2"
		style="position: absolute; overflow: hidden; left: 199px; top: 149px; width: 613px; height: 48px; z-index: 12">
		<img border=0 width="100%" height="100%" alt=""
			src="<%=appUrl %>natkhat/images/roundrect16005983.gif">
	</div>

	<div id=""
		style="position: absolute; overflow: hidden; left: 216px; top: 162px; width: 178px; height: 25px; z-index: 13">
		<div class="wpmd">
			<div>
	...
	<div id=""
		style="position: absolute; overflow: hidden; left: 496px; top: 162px; width: 190px; height: 25px; z-index: 14">
		<div class="wpmd">
			<div>
				<font color="#000000" face="Copperplate Gothic Bold" class="ws16">Select
					Section</font>
	...
	<div id="docsErrorMsg"
		style="display:none;position: absolute; overflow: hidden; left: 634px; top: 326px; width: 1564px; height: 206px; z-index: 4;">
	...
	<form id="documentForm" action="clrkSearchStuList">
		<select name="sClass" id="sClass"
			style="position: absolute; width: 102px; left: 376px; top: 162px; z-index: 15">
		...
		<select name="sSection" id="sSection"
			style="position: absolute; width: 114px; left: 678px; top: 162px; z-index: 16">
		...
		<input name="bName" id="bName" type="text" <% if(null != bName){ %> value="<%=bName %>" <% } %>
			style="position: absolute; width: 220px; left: 252px; top: 250px; z-index: 10">
		<input name="bScholar" id="bScholar" type="text" <% if(null != bScholar){ %> value="<%=bScholar %>" <% } %>
			style="position: absolute; width: 220px; left: 668px; top: 250px; z-index: 11">
		<input type="button" id="submitDocs" style="position: absolute; left: 418px; top: 326px; z-index: 16;" value="Search Student"> 
		<input type="button" id="refreshSearch" style="position: absolute; left: 553px; top: 326px; z-index: 16;" value="Refresh"> 
