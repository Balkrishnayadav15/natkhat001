...
%>
	...
	<div id="formimage2"
		style="position: absolute; left: 790px; top: 100px; z-index: 6">
		<input type="image" name="formimage2" width="171" height="30"
			style="border: 2px solid white; padding: 0px; border-radius: 15px; background-color: white; box-shadow: 0px 3px 0 0;"
			src="<%=appUrl %>natkhat/images/MessageAll.png">
	</div>
	<div id="formimage1"
		style="position: absolute; left: 790px; top: 140px; z-index: 5">
		<input type="image" name="formimage1" width="171" height="30"
			style="border: 2px solid white; padding: 0px; border-radius: 15px; background-color: white; box-shadow: 0px 3px 0 0;"
			src="<%=appUrl %>natkhat/images/TransferAll2.png">
	</div>
	<div id="formimage2"
		style="position: absolute; left: 750px; top: 190px; z-index: 6">
		<input type="image" name="formimage2" width="230" height="50" data-toggle="modal" data-target="#bulkUploadModal"
			style="border: 2px solid white; padding: 5px; border-radius: 15px; background-color: white; box-shadow: 0px 3px 0 0;"
			src="<%=appUrl %>natkhat/images/uploadExcelFile.png">
	</div>
	 <!-- Start Enquiry Modal Modal -->
  <div id="bulkUploadModal" class="modal fade 	" role="dialog" tabindex="-1">
    <div class="modal-dialog">
        ...
        <div class="modal-content enquiry-form">
            <div class="modal-body">
                ...
                <h4><label  class="enqiry-font" style="font-weight: bold;font-size: 31px;color: #3a19bdb8;">Bulk Upload Admission Form</label></h4>
               		<div class="form-group">
                        <label for="name" class="enqiry-font"> Upload Excel File:</label>
                   		 	<input type="file" name="fl_upload">
  							<input type="hidden" value="natkhat001" name="franchise">
                    </div>
                   <input id="submit_image" type="submit" name="image" class="btn btn-lg btn-danger btn-block" value="Upload"/>
                </form>
            </div>
        </div>
    </div>
 ...
 <!-- End Enquiry Modal Modal -->
	<div id="formimage2"
		style="position: absolute; left: 750px; top: 260px; z-index: 6">
		<input type="image" name="formimage2" width="230" height="50"
			style="border: 2px solid white; padding: 5px; border-radius: 15px; background-color: white; box-shadow: 0px 3px 0 0;"
			src="<%=appUrl %>natkhat/images/copyStudentInformation.png">
	</div>
...
<form id="searchForm" method="get" action="getStudent">
		<input type="hidden" value="" name="key" id="searchKey"> <input
			...
			<input
			type="hidden" value="bulk" name="upload">
	</form>
