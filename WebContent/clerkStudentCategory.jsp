...
<%
	...
	String sCategory = (String)request.getAttribute("CATEGORY");
...
%>
	...
	<div id="roundrect1"
		...
		<img border=0 width="100%" height="100%" alt=""
			src="<%=appUrl %>natkhat/images/roundrect16123966.gif">
	</div>

	<div id="sstudent"
		style="position: absolute; overflow: hidden; left: 397px; top: 119px; width: 241px; height: 30px; z-index: 7">
		<div class="wpmd">
			<div align=center>
	...
	<div id=""
		style="position: absolute; overflow: hidden; left: 654px; top: 162px; width: 212px; height: 25px; z-index: 13">
		<div class="wpmd">
			<div>
				<font color="#000000" face="Copperplate Gothic Bold" class="ws16">Select
					Category</font>
...
<form id="categoryForm" action="clrkSearchCategory" >
	...
	<select name="sCategory" id="sCategory"
		style="position: absolute; left: 866px; top: 162px; width: 98px; z-index: 14">
		<option value="" <% if(null == sCategory){ %> selected <% } %>>Select</option>
		<option value="General" <% if(null != sCategory && "General".equals(sCategory)){ %>
				selected <% } %>>General</option>
		<option value="OBC" <% if(null != sCategory && "OBC".equals(sCategory)){ %>
				selected <% } %>>OBC</option>
		<option value="ST" <% if(null != sCategory && "ST".equals(sCategory)){ %>
				selected <% } %>>ST</option>
		<option value="SC" <% if(null != sCategory && "SC".equals(sCategory)){ %>
				selected <% } %>>SC</option>
	</select>
	
	<input name="submitCategory" id="submitCategory" type="button" style="position: absolute; left: 384px; top: 263px; z-index: 16;" value="Search Student">
	<input type="button" id="refreshCategory" style="position: absolute; left: 548px; top: 263px; z-index: 16;" value="Refresh"> 
