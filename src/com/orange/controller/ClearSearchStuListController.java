...
@WebServlet("/clrkSearchStuList")
public class ClearSearchStuListController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//Dashboard data
		List<StudentInfo> allSelStudent = dao.clerkStuListSearch(sClass, sSection, bName, bScholar);
		...
		String adminJsp = "/clerkStudentListSection.jsp";
